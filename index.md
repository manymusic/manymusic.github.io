...
This project is still ongoing. We finished the stimulus curation and validation phases, and we finished collecting EEG+ data.
Currently, we are collecting fMRI+ data. We expect to complete the data collection by September 2026.
The data and code will be made openly available upon the project completion.

Please see our recent [poster] for the current status of the project as of Jan 2026.

## News & Updates

- 2026-05-07: [ManyMusic-Acq] fMRI+ data acquisition has been started! Check out the dashboard for the current progress. 🧠
- 2026-05-04: [ManyMusic-Rec] EEG+ data acquisition is completed! We are now preparing the data for public release. Stay tuned! 🎉
